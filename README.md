...
This release is `1.0.0`. The command list is intentionally small so the tool stays easy to use.
...
- Version is consistent: package and CLI both report `1.0.0`.
- The public CLI command list is focused on the core product flow.
- Noisy commands that were not core to the product flow are left out.
