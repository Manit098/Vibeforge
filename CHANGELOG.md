...
This release keeps VibeForge focused on the workflow it actually supports.

### Changed

- Version is consistent across package metadata, CLI output, and dashboard branding.
