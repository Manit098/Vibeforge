    ...
    <div class="grid grid-sidebar">
      ...
      <div>
        <div class="card" style="margin-bottom:1.25rem;">
          <div class="card-title">💡 What is a Handoff?</div>
          <p style="font-size:0.88rem;color:var(--text-muted);line-height:1.6;margin-top:0.5rem;">
            ...
            instant understanding of your project. It includes your current branch, 
          ...
          <p style="font-size:0.88rem;color:var(--text-muted);line-height:1.6;margin-top:0.75rem;">
            <strong style="color:var(--text);">How to use:</strong> Click Generate → Copy → 
            Paste into any AI chat window as your opening message.
          </p>
        </div>
        <div class="card" style="margin-bottom:1.25rem;">
