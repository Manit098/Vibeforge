...
export const checklistPage = (): string => {
      ...
      <div>
        ...
        <div class="card">
          ...
          <div style="display:flex;flex-direction:column;gap:0.5rem;margin-top:0.75rem;">
            <button class="btn btn-ghost btn-sm" onclick="clearDone()">🗑️ Clear Completed</button>
  ...
  const script = `
    ...
    function renderTasks() {
      ...
      if(!tasks.length){ el.innerHTML = '<div class="empty"><div class="empty-icon">📋</div>No tasks yet. Add one above!</div>'; return; }
