...
export const getStyles = (): string => `
  :root {
    ...
    --bg-secondary: #11141b;
    --bg-card: #151923;
    --bg-card-hover: #191e29;
    --bg-input: #0f131b;
    --border: rgba(255, 255, 255, 0.08);
    --border-hover: rgba(147, 165, 190, 0.35);
    --accent: #7c4dff;
    --accent-glow: rgba(124, 77, 255, 0.18);
    --accent2: #4fc3f7;
    --accent2-glow: rgba(79, 195, 247, 0.12);
    --text: #eef2f7;
    --text-muted: #9aa4b2;
    --text-dim: #6f7a8a;
    --color-commit: #4fc3f7;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-primary:hover { background: #6f43e6; }
  .btn-ghost {
    background: rgba(255,255,255,0.03);
  ...
  .badge-commit { background: rgba(79,195,247,0.08); border: 1px solid rgba(79,195,247,0.22); color: var(--color-commit); }
  .badge-prompt { background: rgba(102,187,106,0.08); border: 1px solid rgba(102,187,106,0.22); color: var(--color-prompt); }
  .badge-memory { background: rgba(186,104,200,0.08); border: 1px solid rgba(186,104,200,0.22); color: var(--color-memory); }
  .badge-plan { background: rgba(255,183,77,0.08); border: 1px solid rgba(255,183,77,0.22); color: var(--color-plan); }
  .badge-watcher { background: rgba(255,213,79,0.08); border: 1px solid rgba(255,213,79,0.22); color: var(--color-watcher); }
  .badge-system { background: rgba(239,83,80,0.08); border: 1px solid rgba(239,83,80,0.22); color: var(--color-system); }
